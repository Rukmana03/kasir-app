      ...
      <form onSubmit={fetchLaporan} className="mb-4">
        <div className="row g-2 align-items-end">
          <div className="col-md-3">
            ...
            <select id="month" className="form-select" value={month} onChange={(e) => setMonth(e.target.value)}>
          ...
          <div className="col-md-3">
            <label htmlFor="year" className="form-label fw-medium">
              Tahun
            </label>
            <select id="year" className="form-select" value={year} onChange={(e) => setYear(e.target.value)}>
              {years.map((y) => (
