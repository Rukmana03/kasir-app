    ...
    <div className="container-fluid px-0 fade-in">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <Link to="/meja/create" className="btn btn-primary rounded-pill btn-add-responsive d-flex align-items-center">
          <i className="fas fa-plus me-2"></i><span className="d-none d-md-inline">Tambah Meja</span>
        </Link>
      </div>
        ...
        <div className="card-body p-0">
          ...
          <div className="table-responsive p-4">
            <table className="table align-middle table-hover mb-0" id="mejaTable">
              ...
              <tbody>
                {isLoading ? (
                  <tr><td colSpan="4" className="text-center py-5"><i className="fas fa-spinner fa-spin fa-2x text-primary"></i></td></tr>
                ) : mejas.length === 0 ? (
                  <tr>
                    ...
                    <tr key={r.id_meja}>
                      ...
                      <td>
                        <div className="d-flex align-items-center gap-2">
                          <div className="table-icon"><i className="fas fa-chair text-primary"></i></div>
                      ...
                      <td>
                        ...
                        {r.status_meja === 'Terisi' ? (
                          <span className="badge bg-warning-subtle text-warning"><i className="fas fa-user-friends me-1"></i> Terisi</span>
                        ) : (
                          <span className="badge bg-success-subtle text-success"><i className="fas fa-check-circle me-1"></i> Tersedia</span>
                        )}
                      </td>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content border-0 shadow">
              ...
              <div className="modal-body text-center py-4">
                <div className="text-danger mb-3"><i className="fas fa-chair fa-3x"></i></div>
