...
export default function MenuCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Tembak API Backend
      await axios.post(import.meta.env.VITE_API_BASE_URL + '/menu', {
      ...
      <div className="card border-0 shadow-sm rounded-4 overflow-hidden" style={{ transition: 'transform .2s ease, box-shadow .2s ease' }}>
        <div className="card-body p-4">
          <form onSubmit={handleSubmit} className="row g-3" noValidate>
            ...
            {/* Kategori */}
            <div className="col-lg-6">
              <label htmlFor="category" className="form-label fw-semibold">Kategori</label>
              <div className="input-group input-group-lg">
                <span className="input-group-text bg-light">
                ...
                <input 
                  ...
                  id="category"
                  className="form-control"
                  placeholder="Contoh: Mie / Minuman"
                  value={kategori}
