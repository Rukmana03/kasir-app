...
export default function BahanIndex() {
  ...
  const handleTambahBahan = async (e) => {
    ...
    setIsLoading(true);
    try {
      await axios.post(import.meta.env.VITE_API_BASE_URL + '/bahan', {
            ...
            <div className="card-body p-4">
              ...
              <form onSubmit={handleTambahBahan} className="row g-3">
                ...
                <div className="col-sm-5">
                  ...
                  <div className="input-group input-group-sm">
                    <span className="input-group-text bg-light"><i class="fas fa-ruler text-muted"></i></span>
            ...
            <div className="card-body p-4">
              ...
              <div className="table-responsive mt-3" style={{ maxHeight: '60vh', overflow: 'auto' }}>
                <table className="table table-sm align-middle table-hover">
                  ...
                  <tbody>
                    {isFetching ? (
                      <tr><td colSpan="4" className="text-center py-4"><i className="fas fa-spinner fa-spin text-primary"></i> Memuat...</td></tr>
                    ) : bahan.length === 0 ? (
                      <tr>
                        ...
                        <tr key={b.id_bahan}>
                          ...
                          <td>
                            {b.jenis_bahan === 'kering' ? (
                              <span className="badge bg-warning text-dark"><i className="fas fa-box me-1"></i>Kering</span>
                            ) : (
                              <span className="badge bg-info text-dark"><i className="fas fa-tint me-1"></i>Basah</span>
                            )}
                          </td>
                          <td><span className="badge bg-light text-dark border">{b.satuan}</span></td>
                ...
                <form onSubmit={handleSimpanEdit} className="row g-3">
                  <div className="col-12">
                    ...
                    <input 
                      ...
                      value={editForm.nama_bahan} 
                      onChange={(e) => setEditForm({...editForm, nama_bahan: e.target.value})} 
                      required 
                    />
                  </div>
                  <div className="col-6">
                    ...
                    <select 
                      ...
                      value={editForm.jenis_bahan} 
                      onChange={(e) => setEditForm({...editForm, jenis_bahan: e.target.value})}
                    >
                  ...
                  <div className="col-12 mt-4 d-flex gap-2 justify-content-end">
                    <button type="button" className="btn btn-light rounded-pill px-4" onClick={closeEditModal}>Batal</button>
