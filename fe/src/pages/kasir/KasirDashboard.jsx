          ...
          <div className="card border-0 bg-info text-white shadow-sm h-100 rounded-4" style={{ cursor: 'pointer' }} onClick={handleTakeaway}>
            <div className="card-body d-flex align-items-center justify-content-between p-4">
              <div>
                ...
                <div className="h3 fw-bold mb-0"><i className="fas fa-shopping-bag"></i></div>
              </div>
      ...
      {!loading && (
        <div className="row g-4">
                  ...
                  <div className="card-body p-4 d-flex flex-column">
                      ...
                      <form onSubmit={(e) => handleMulaiPesanan(e, meja)} className="mt-auto">
                        ...
                        <div className="input-group input-group-sm mb-3 shadow-sm rounded-3">
                          ...
                          <input 
                            ...
                            value={customerNames[meja.id_meja] || ''}
                            onChange={(e) => handleInputChange(meja.id_meja, e.target.value)}
                          />
                        </div>
                    ...
                    {isTerisi && (
                      <form onSubmit={(e) => handleKosongkanMeja(e, meja)} className="mt-auto">
                        <div className="alert alert-warning py-2 small text-center mb-3 border-0">
                          Meja sedang melayani pesanan.
                        </div>
          ...
          <div className="col-6 col-md-4 col-lg-3">
            <div 
              className="card h-100 border-0 shadow-sm rounded-4 takeaway-card text-white cursor-pointer" 
